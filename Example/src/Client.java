...
public class Client{
  ...
  public static void main(String argv[]) throws Exception
  {
    ...
    //System.out.println("RTSP_server_port (Client) : ");
    int RTSP_server_port = 4005; // = Integer.parseInt(argv[1]);
    
    //System.out.println("RTSP_server_host (Client) : ");
    String ServerHost = "localhost";
    InetAddress ServerIPAddr = InetAddress.getByName(ServerHost);

    //get video filename to request:
    //System.out.println("Video filename : ");
    VideoFileName = "my.mpg"; //scanner.nextLine();
...
System.out.println("all connection ok");
