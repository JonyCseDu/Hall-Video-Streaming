...
import com.movieCart.VideoPanelClass;
import com.movieCart.Objects.GridPacket;
import com.movieCart.Objects.RequestObject;
import com.movieCart.client.managers.GridClientManager;
...
public class GridFrame extends JFrame{
	...
	ArrayList<GridPacket> list=new ArrayList<GridPacket>();
	
	public GridFrame() {
		this("");
	}
	
	public GridFrame(String key) {
		super("Browse video");
	...
	void create_gridFrame(){
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				new GridFrame(textField.getText());
				setVisible(false);
...
//			panel.setBackground(Color.magenta);
			...
			GridPacket object=list.get(i);
			
			
			
			JPanel panel =  new GridPanel(object); // Make a new panel
