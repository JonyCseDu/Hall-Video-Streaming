...
import com.movieCart.client.managers.LoginSignUpClientManager;
...
public class SignupLoginFrame extends JFrame  {
	...
	public SignupLoginFrame()  {
		...
		b2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				SignupLoginPacket packet = new SignupLoginPacket(email.getText(),
				...
				{
					if(!LoginSignUpClientManager.serverCheck(packet)){
						label.setText("Unsuccessful. Try again");
					}
					else{
	...
	public Boolean logic(SignupLoginPacket packet)
	{
